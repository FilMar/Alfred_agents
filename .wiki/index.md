...
| [stateless_cockpit](stateless_cockpit) | Founded 2026-08-08 in `tools/cockpit/`: tailnet web UI, episodic stateless execution, `:mem` banks — replaces Matrix chat and pi-web. Milestone 1 built (fake agent), edges pending |
