...
```bash
python3 /home/filippo/git_projects/pi/skills/courier/scripts/youtube.py "<URL1>" "<URL2>" ...
```
...
```bash
python3 /home/filippo/git_projects/pi/skills/courier/scripts/article.py "<URL>"
```
